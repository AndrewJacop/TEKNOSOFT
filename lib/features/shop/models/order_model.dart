...
class OrderModel {
  ...
  String get formattedOrderDate => UtHelperFunctions.getFormattedDate(orderDate);

  String get formattedDeliveryDate => deliveryDate != null ? UtHelperFunctions.getFormattedDate(deliveryDate!) : "";
